...
export const copy = {
  vi: {
    ...
    minPrice: 'Giá tối thiểu', maxPrice: 'Mức giá trần', priceRange: 'Khoảng giá', noLimit: 'Không trần',
    minPricePlaceholder: 'Tối thiểu (k)', maxPricePlaceholder: 'Giá trần (k)',
    priceRangeError: 'Giá tối thiểu không được lớn hơn mức giá trần.',
    noDishesInRange: 'Không có món nào trong khoảng giá này. Hãy thử nới rộng khoảng giá.',
    allDishes: 'Tất cả',
  ...
  en: {
    ...
    minPrice: 'Min price', maxPrice: 'Ceiling price', priceRange: 'Price range', noLimit: 'No limit',
    minPricePlaceholder: 'Min (k)', maxPricePlaceholder: 'Ceiling (k)',
    priceRangeError: 'Min price cannot exceed ceiling price.',
    noDishesInRange: 'No dishes match this price range. Try widening the range.',
    allDishes: 'All',
